...
public class paymentsController extends Controller {
    ...
    @Inject
    public paymentsController(WSClient ws) {
        this.ws = ws;
    ...
    public CompletionStage<Result> fetchAllAuditTrail(Http.Request request) {
        ...
        return ws.url(apiUrl)
                ...
                .thenApplyAsync(response -> {
                    ...
                    return ok(views.html.payments.render(Json.toJson(auditTrailResponse), mpesaRef, serviceCode));
                });
    }

    public CompletionStage<Result> payments(Http.Request request) {
